...
class OllamaEmbedderFactory(_interactions.CreatorFactory[str, _interactions.EmbeddingVector]):
...
class OllamaEmbedder(_interactions.Creator[str, _interactions.EmbeddingVector]):
...
#        client.chat(model_name, options=base_options)
    ...
    def _create_object_from(self, description: str) -> _interactions.EmbeddingVector:
        try:
