...
class TelegramChatbotDiscussion(ChatbotDiscussion[TelegramChatbotMessage]):
    def __init__(self, message_methods: _T.Sequence[_T.Type[TelegramChatbotMessage]], loop: _asyncio.AbstractEventLoop, creators: CreatorsMap, creators_state: CreatorsState, bot: _telegram.Bot, directory: TelegramDiscussionSaver) -> None:
    ...
    async def handle_message(self, specs: ChatbotSpecs, update: _telegram.Update) -> bool:
