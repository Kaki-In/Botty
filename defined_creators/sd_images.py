...
from defined_creators.used_objects import ImageSettings
...
class StableDiffusionImageGeneratorFactory(CreatorFactory[ImageSettings, _local_utils_images.Image]):
    def build_from(self, directory: _saves.ResourcesDirectory) -> Creator[ImageSettings, _local_utils_images.Image]:
...
class StableDiffusionImageGenerator(Creator[ImageSettings, _local_utils_images.Image]):
    ...
    def _create_object_from(self, description: ImageSettings) -> _local_utils_images.Image:
